...
// plugins/canvas-viz/node_modules/react-simple-code-editor/lib/index.js
var require_lib = __commonJS({
  "plugins/canvas-viz/node_modules/react-simple-code-editor/lib/index.js"(exports) {
    "use strict";
    ...
    var React2 = __importStar(require("react"));
    var KEYCODE_Y = 89;
    var KEYCODE_Z = 90;
    var KEYCODE_M = 77;
    ...
    var Editor2 = React2.forwardRef(function Editor3(props, ref) {
      ...
      return React2.createElement(
        ...
        React2.createElement("pre", __assign({ className: preClassName, "aria-hidden": "true", style: __assign(__assign(__assign({}, styles.editor), styles.highlight), contentStyle) }, typeof highlighted === "string" ? { dangerouslySetInnerHTML: { __html: highlighted + "<br />" } } : { children: highlighted })),
...
// plugins/canvas-viz/node_modules/prismjs/prism.js
var require_prism = __commonJS({
  "plugins/canvas-viz/node_modules/prismjs/prism.js"(exports, module2) {
...
// plugins/canvas-viz/renderer/utils/sandbox.ts
var LIBRARIES = {
...
// plugins/canvas-viz/renderer/components/CodeEditor.tsx
var import_react_simple_code_editor = __toESM(require_lib());
var import_prismjs = __toESM(require_prism());

// plugins/canvas-viz/node_modules/prismjs/components/prism-clike.js
...
// plugins/canvas-viz/node_modules/prismjs/components/prism-javascript.js
...
var CodeEditor = ({ code, onChange }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-full overflow-auto bg-gray-950 font-mono text-sm border-r border-gray-800", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react_simple_code_editor.default,
    {
      value: code,
      onValueChange: onChange,
      highlight: (code2) => (0, import_prismjs.highlight)(code2, import_prismjs.languages.js || import_prismjs.languages.javascript, "javascript"),
      padding: 10,
      style: {
...
// plugins/canvas-viz/renderer/components/Toolbar.tsx
...
var Toolbar = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between px-2 py-1 bg-gray-900 border-b border-gray-800", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: onRun, className: "text-green-400 hover:text-green-300 text-xs px-2 py-1", children: "Run" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: onPause, className: "text-yellow-400 hover:text-yellow-300 text-xs px-2 py-1", children: isPaused ? "Resume" : "Pause" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: onReset, className: "text-gray-400 hover:text-white text-xs px-2 py-1", children: "Reset" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: () => setView("canvas"), className: `text-xs px-2 py-1 ${view === "canvas" ? "text-blue-400" : "text-gray-400"}`, children: "Canvas" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: () => setView("editor"), className: `text-xs px-2 py-1 ${view === "editor" ? "text-blue-400" : "text-gray-400"}`, children: "Code" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: () => setView("split"), className: `text-xs px-2 py-1 ${view === "split" ? "text-blue-400" : "text-gray-400"}`, children: "Split" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-px h-4 bg-gray-800 mx-1" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: onExportImage, className: "text-gray-400 hover:text-white text-xs px-2 py-1", children: "Export PNG" })
    ] })
  ] });
};
...
var activate = (context) => {
  ...
  const CanvasRenderer = (props) => {
    ...
    const [iframeSrc, setIframeSrc] = (0, import_react.useState)("");
    const iframeRef = (0, import_react.useRef)(null);
    const libraries = (0, import_react.useMemo)(() => {
      const libs = [];
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col h-[500px] border border-gray-800 rounded bg-gray-950 overflow-hidden my-2 shadow-lg", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex-1 flex overflow-hidden relative", children: [
        (view === "split" || view === "editor") && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: `${view === "split" ? "w-1/2" : "w-full"} h-full border-r border-gray-800 overflow-hidden`, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CodeEditor, { code, onChange: setCode }) }),
        (view === "split" || view === "canvas") && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: `${view === "split" ? "w-1/2" : "w-full"} h-full bg-black relative`, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "iframe",
          {
            ref: iframeRef,
            src: iframeSrc,
