...
// plugins/code-interpreter/node_modules/react-simple-code-editor/lib/index.js
var require_lib = __commonJS({
  "plugins/code-interpreter/node_modules/react-simple-code-editor/lib/index.js"(exports) {
    "use strict";
    ...
    var Editor2 = React2.forwardRef(function Editor3(props, ref) {
      ...
      return React2.createElement(
        "div",
        __assign({}, rest, { style: __assign(__assign({}, styles2.container), style) }),
        React2.createElement("pre", __assign({ className: preClassName, "aria-hidden": "true", style: __assign(__assign(__assign({}, styles2.editor), styles2.highlight), contentStyle) }, typeof highlighted === "string" ? { dangerouslySetInnerHTML: { __html: highlighted + "<br />" } } : { children: highlighted })),
        React2.createElement("textarea", { ref: function(c) {
          return inputRef.current = c;
        }, style: __assign(__assign(__assign({}, styles2.editor), styles2.textarea), contentStyle), className: className + (textareaClassName ? " ".concat(textareaClassName) : ""), id: textareaId, value, onChange: handleChange, onKeyDown: handleKeyDown, onClick, onKeyUp, onFocus, onBlur, disabled, form, maxLength, minLength, name, placeholder, readOnly, required, autoFocus, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", spellCheck: false, "data-gramm": false }),
...
// plugins/code-interpreter/node_modules/prismjs/prism.js
var require_prism = __commonJS({
  "plugins/code-interpreter/node_modules/prismjs/prism.js"(exports, module2) {
...
// plugins/code-interpreter/node_modules/prismjs/components/prism-clike.js
...
// plugins/code-interpreter/node_modules/prismjs/components/prism-javascript.js
...
// plugins/code-interpreter/node_modules/prismjs/components/prism-python.js
...
var activate = (context) => {
  ...
  const CodeBlockRenderer = ({ context: { code: initialCode, language } }) => {
    ...
    const [sessionId, setSessionId] = (0, import_react.useState)(localStorage.getItem(`code-interpreter-session-${language}`));
    (0, import_react.useEffect)(() => {
      if (sessionId) {
        localStorage.setItem(`code-interpreter-session-${language}`, sessionId);
      }
    }, [sessionId, language]);
    const highlight = (code2) => {
      if (language === "python" || language === "py") {
        return import_prismjs.default.highlight(code2, import_prismjs.default.languages.python || import_prismjs.default.languages.clike, "python");
      } else {
        return import_prismjs.default.highlight(code2, import_prismjs.default.languages.javascript || import_prismjs.default.languages.clike, "javascript");
      }
    };
    const handleRun = async () => {
      ...
      try {
        ...
        if (!currentSessionId) {
          const result2 = await context.ipc.invoke("create-session", { language: language === "py" ? "python" : language });
          if (result2.error) {
            throw new Error(result2.error);
          }
          currentSessionId = result2.sessionId;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "my-2 rounded-lg overflow-hidden border border-white/10 bg-[#1e1e1e]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between px-3 py-2 bg-white/5 border-b border-white/5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [
          ...
          sessionId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-[10px] text-green-500 bg-green-500/10 px-1 rounded", children: "Active Session" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-2", children: [
          sessionId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              onClick: handleReset,
              disabled: isRunning,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "p-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      (output || error) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `border-t border-white/10 p-3 ${error ? "bg-red-900/20" : "bg-black/50"}`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-xs text-gray-500 mb-1 uppercase tracking-wider flex justify-between", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: error ? "Error" : "Output" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { className: `text-xs font-mono whitespace-pre-wrap ${error ? "text-red-300" : "text-white"}`, children: error || output })
      ] })
    ] });
  };
