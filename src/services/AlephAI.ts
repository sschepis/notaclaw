...
export class AlephAIService implements IAlephAI {
    ...
    async complete(request: AlephAIRequest): Promise<AlephAIResponse> {
        if (!this.geminiKey) throw new Error('AlephAI: Missing API Key');
