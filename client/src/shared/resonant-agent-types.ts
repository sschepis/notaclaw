 ...
 *   - AgentTeam (from both files)       — multi-agent teams
 *
...
import type { AgentTeam as LocalAgentTeam } from './agent-types';
...
/** Convert legacy local AgentTeam to ResonantAgentTeam */
export function localTeamToResonant(team: LocalAgentTeam): ResonantAgentTeam {
  return {
    id: team.id,
    name: team.name,
