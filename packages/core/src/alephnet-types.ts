...
export interface AlephNetIPCMap {
  ...
  // Decentralized Web
  'dweb:resolve': { params: { domain: string }; result: string | null };
  'dweb:fetch': { params: { cid: string }; result: string | null };
  'dweb:fetchFile': { params: { domain: string; path: string }; result: { content: string; mimeType: string } | null };
}
